> **DEPRECATED**: This document represents an earlier economic model (stevemon / CHF peg) and is preserved for historical reference only. The canonical Whitepaper is `/WHITEPAPER.md` (Genesis Draft v1.0).
